...
{
    private const string SPRITESHEET_PATH = "Assets/Sprites/Animals/Chickens_and_Roosters_32x32/Rooster_Gray_32x32.png";
    ...
    private const string BASE = "Rooster_Gray_32x32";
